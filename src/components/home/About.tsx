    ...
    <section className="relative py-14 flex justify-center items-center overflow-hidden md:py-32">
      ...
      <div className="relative z-10 text-black">
        <div className="flex items-center justify-end my-14">
          ...
          <h1 className="text-xl md:text-2xl border-2 cursor-pointer border-black px-5 py-1 rounded-full">
            About
          </h1>
        </div>
        ...
        <h1 className="text-4xl md:text-7xl text-center font-bold">
          {" "}
          Websites since{" "}
          <span className="bg-black px-3 py-1 rounded-2xl text-white">
            2013
          </span>
        </h1>
        ...
        <div className="mt-8 hidden md:block">
          <PreviouslyWorkedOn></PreviouslyWorkedOn>
        </div>
      </div>
    </section>
  );
